...
SHELL_STATIC_SUBCMD_SET_CREATE(
    ...
    SHELL_CMD_NO_ARGS(low, "battery low",
                      []()
                      {
                          Teufel::Task::Bluetooth::postMessage(
                              Teufel::Ux::System::Task::Audio,
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_si, SHELL_CMD_ARG(play, &sub_si_play, "", NULL, 2, 1),
...
SHELL_CMD_ARG_REGISTER(
    ...
    +[]()
    {
        Teufel::Task::Audio::postMessage(Teufel::Ux::System::Task::Audio,
                                         Teufel::Ux::System::BatteryLowLevelState::Below10Percent);
    },
    2, 0);
SHELL_CMD_ARG_REGISTER(
    l5, NULL, "low5",
    ...
    {
        Teufel::Task::Audio::postMessage(Teufel::Ux::System::Task::Audio,
                                         Teufel::Ux::System::BatteryLowLevelState::Below5Percent);
    },
    2, 0);

SHELL_CMD_ARG_REGISTER(
    version, NULL, "Firmware version", +[]() { printf("%d.%d.%d\r\n", VERSION_MAJOR, VERSION_MINOR, VERSION_PATCH); },
    0, 0);

SHELL_STATIC_SUBCMD_SET_CREATE(sub_bass,
                               SHELL_CMD_PARSED_INT8(set, "set bass[-6..6]", CONFIG_DSP_BASS_MIN, CONFIG_DSP_BASS_MAX,
                                                     [](int8_t v) { board_link_amps_set_bass_level(v); }),
                               SHELL_SUBCMD_SET_END /* Array terminated. */
);
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_treble,
                               SHELL_CMD_PARSED_INT8(set, "set treble[-6..6]", CONFIG_DSP_TREBLE_MIN,
                                                     CONFIG_DSP_TREBLE_MAX,
                                                     [](int8_t v) { board_link_amps_set_treble_level(v); }),
                               SHELL_SUBCMD_SET_END /* Array terminated. */
);
...
static PropertyNonOpt<decltype(Teufel::Ux::System::ChargeLimitMode::value)> m_charge_limit_mode{"charge limit mode",
                                                                                                false, false};
...
void factory_test_key_process()
{
    if (is_key_test_activated() || power_on_with_prompt)
    {
        ...
        if (key_test_start_time != 0)
        {
            ...
            uint8_t power_bt_play_plus_minus_btns_all_pressed =
                BUTTON_ID_POWER | BUTTON_ID_BT | BUTTON_ID_PLAY | BUTTON_ID_PLUS | BUTTON_ID_MINUS; // 0b11111
...
SHELL_CMD_ARG_REGISTER(
    ...
    +[]()
    {
        if (test_mode_activated)
        {
            ...
            board_link_usb_switch_to_bluetooth(); // Eastech will need to press PWR+BT combo again after exiting, to
                                                  // route uart 2 usb
        }
        else
        {
...
SHELL_CMD_ARG_REGISTER(
    A2, NULL, "t: LED A Red, LED B Green",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    A3, NULL, "t: LED A Green, LED B Blue",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    A4, NULL, "t: LED A Blue, LED B Red",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    A6, NULL, "t: Battery Level Detection",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    A7, NULL, "t: Battery Voltage Detection",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    A9, NULL, "t: Volume",
    +[](const struct shell *, size_t argc, char **argv)
    {
        if (test_mode_activated)
        {
            Teufel::Task::Bluetooth::postMessage(Teufel::Ux::System::Task::Audio,
                                                 Teufel::Ux::Bluetooth::SetVolumeProdTest{(uint8_t) atoi(argv[1])});
        }
    },
    2, 1);

SHELL_CMD_ARG_REGISTER(
    AA, NULL, "t: Get BT MAC",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AB, NULL, "t: Clear BT Paired Device List",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AC, NULL, "t: AUX Connection Detection",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AE, NULL, "t: Battery Temperature Detection",
    +[]()
    {
        if (test_mode_activated)
        {
    ...
    +[]()
    {
        if (test_mode_activated)
        {
            ...
            Teufel::Task::System::postMessage(Teufel::Ux::System::Task::Audio,
                                              Teufel::Ux::System::SetPowerState{Teufel::Ux::System::PowerState::Off,
...
SHELL_CMD_ARG_REGISTER(
    AL, NULL, "t: Enter AUDIO BYPASS MODE",
    +[]()
    {
        if (test_mode_activated)
        {
            Teufel::Task::Bluetooth::postMessage(Teufel::Ux::System::Task::Audio,
                                                 Teufel::Ux::Bluetooth::AudioBypassProdTest::Enter);
            printf("OK\r\n");
        }
    },
    2, 1);
...
SHELL_CMD_ARG_REGISTER(
    AM, NULL, "t: Exit AUDIO BYPASS MODE",
    +[]()
    {
        if (test_mode_activated)
        {
            Teufel::Task::Bluetooth::postMessage(Teufel::Ux::System::Task::Audio,
                                                 Teufel::Ux::Bluetooth::AudioBypassProdTest::Exit);
            printf("OK\r\n");
        }
    },
    2, 1);
...
SHELL_CMD_ARG_REGISTER(
    AT00, NULL, "t: Write Speaker Color To Black",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AT01, NULL, "t: Write Speaker Color To White",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AT02, NULL, "t: Write Speaker Color To Wild Berry",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AT03, NULL, "t: Write Speaker Color To Light Mint",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    Ap, NULL, "t: Set Battery Charge Limit",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AQ, NULL, "t: Close Battery Charge Function",
    +[]()
    {
        if (test_mode_activated)
        {
...
SHELL_CMD_ARG_REGISTER(
    AHV, NULL, "t: Get Hardware Version",
    +[]()
    {
        if (test_mode_activated)
        {
